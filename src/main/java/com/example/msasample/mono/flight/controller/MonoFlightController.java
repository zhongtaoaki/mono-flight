...
public class MonoFlightController {
	...
	@DeleteMapping("/flight/{flightReservationId}")
	public void deleteFlight(@PathVariable Long flightReservationId) {
		flightReserveService.deleteFlight(flightReservationId);
	}
